...
public class ItemGroupInit {
    public static final Text FANTASY_TITLE = Text.translatable("itemGroup." + RealmfantasyMod.MOD_ID + ".fantasy_group");
    ...
    public static final ItemGroup FANTASY_GROUP = register("fantasy_group", FabricItemGroup.builder()
            ...
            .entries((displayContext, entries) -> Registries.ITEM.getIds()
                    .stream()
                    .filter(key ->key.getNamespace().equals(RealmfantasyMod.MOD_ID))
    ...
    public static <T extends ItemGroup> T register(String name, T itemGroup) {
        return Registry.register(Registries.ITEM_GROUP, RealmfantasyMod.id(name), itemGroup);
    }
